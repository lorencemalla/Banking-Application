...
import { RiDashboardLine, RiExchangeFundsLine, RiBankLine, RiFileListLine, RiBillLine, RiBankCardLine, RiHandCoinLine, RiCustomerService2Line, RiSettings3Line, RiAdminLine, RiLogoutBoxLine, RiShieldCheckLine } from 'react-icons/ri';
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-logo">
        ...
        <div>
          <h2>NexusBank</h2>
          <div style={{ fontSize: '0.65rem', color: 'rgba(255,255,255,0.4)', fontWeight: 400, marginTop: 1 }}>Internet Banking</div>
        </div>
      </div>
      ...
      <div style={{ padding: '16px 16px 12px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.4)' }}>Customer</div>
          </div>
        </div>
      </div>

      <nav className="sidebar-nav">
        <div style={{ fontSize: '0.65rem', fontWeight: 600, color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', letterSpacing: 1, padding: '12px 16px 6px' }}>Main Menu</div>
        {navItems.map((item) => (
        ...
        {isAdmin() && (
          <>
            <div style={{ fontSize: '0.65rem', fontWeight: 600, color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', letterSpacing: 1, padding: '16px 16px 6px' }}>Administration</div>
